...
{
    internal class RatKingSpawner : ModTile
    {
        ...
        public virtual string RelicTextureName => "Conquest/Tiles/DirtyCrown";
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(233, 207, 94), Language.GetText("MapObject.Boss"));
        }
        public override void MouseOver(int i, int j)
        {
            ...
            if (NPC.AnyNPCs(ModContent.NPCType<DandukeBoss>()))
                ...
                Main.LocalPlayer.cursorItemIconText = "Touch the pedestal...";
        }
        public override bool RightClick(int i, int j)
        {
            ...
            int npcID = NPC.NewNPC(new EntitySource_TileInteraction(null, i, j), i * 16, j * 16 - 350, ModContent.NPCType<RatKingBoss>());
