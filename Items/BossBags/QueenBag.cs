...
namespace Conquest.Items.BossBags
{
    public class QueenBag : ModItem
    {
        ...
        {
            itemLoot.Add(ItemDropRule.Coins(Item.buyPrice(gold: 1), false));
            itemLoot.Add(ItemDropRule.OneFromOptions(1, ModContent.ItemType<GloriousScepter>(), ModContent.ItemType<GloriousLauncher>(), ModContent.ItemType<GloriousSpear>()));
