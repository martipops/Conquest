...
namespace Conquest.Items.Accessory
{
    public class Wealth : ModItem
    {
        ...
        {
            player.GetModPlayer<MyPlayer>().Glory = true;
        }
        public override bool CanAccessoryBeEquippedWith(Item equippedItem, Item incomingItem, Player player)
        {
            return incomingItem.rare != ModContent.RarityType<ArtifactRarity>() || equippedItem.ModItem is not Wealth;
        }
