...
namespace Conquest.NPCs.LanternNights
{
    public class DragonHead : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("These mythical creatures are hard to come by, although are attracted to lanterns")
            });
        }
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<DragonHorns>()));
        }

        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            return Main.hardMode && LanternNight.LanternsUp ? SpawnCondition.Sky.Chance * 0.05f : 0f;
        }
        ...
        public override void AI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                if (NPC.ai[0] == 0f)
                {
                    ...
                    for (int l = 0; l < 14; l++)
                    {
                        int num9 = ModContent.NPCType<DragonBody>();
                        switch (l)
                        {
                            case 1:
                            case 8:
                                num9 = ModContent.NPCType<DragonLegs>();
                                break;
                            case 11:
                                num9 = ModContent.NPCType<DragonBody2>();
                                break;
                            case 12:
                                num9 = ModContent.NPCType<DragonBody3>();
                                break;
                            case 13:
                                num9 = ModContent.NPCType<DragonTail>();
                                break;
                        }
    ...
    public class DragonBody : ModNPC
    {
        public override void SetStaticDefaults()
        {
    ...
    public class DragonLegs : ModNPC
    {
        public override void SetStaticDefaults()
        {
            NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers(0)
    ...
    public class DragonBody2 : ModNPC
    {
        public override void SetStaticDefaults()
        {
            NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers(0)
    ...
    public class DragonBody3 : ModNPC 
    {
        public override void SetStaticDefaults()
        {
            NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers(0)
    ...
    public class DragonTail : ModNPC
    {
        public override void SetStaticDefaults()
        {
            NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers(0)
